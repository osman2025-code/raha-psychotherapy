...
//*********************** الاقتباسات في صفحة المعالجين ******************************************************************** */

 
    const quotes = [
      "الوعي هو أول طريق التعافي، والصحة النفسية تبدأ حين نصغي بصدق لأعماقنا",
      "الصحة النفسية لا تعني غياب الألم، بل القدرة على تجاوزه",
      "كل لحظة وعي هي خطوة نحو التعافي",
      "من يداوي داخله، يستطيع أن يضيء خارجه",
      "لا بأس بطلب المساعدة، فالشجاعة الحقيقية تبدأ بالاعتراف بالحاجة للدعم",
      "كلما كانت جروحنا أعمق، كلما كان العلاج أكثر ضرورة. لكن التداوي يبدأ من الداخل",
      "النضج النفسي لا يكمن في التكيف مع الحياة كما هي، بل في القدرة على إحداث التغيير في طرق تفكيرنا",
      "أحيانًا، لا تحتاج إلى إصلاح شيء في داخلك، بل تحتاج فقط إلى أن تتقبل الأجزاء التي تحتاج إلى الشفاء."
    ];
